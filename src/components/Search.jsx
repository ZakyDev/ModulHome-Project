...
const Search = () => {
  ...
  return (
    <div className="px-[30px] py-6 max-w-[1170px] mx-auto flex flex-col lg:flex-row justify-between gap-4 lg:gap-x-3 relative lg:-top-4 lg:shadow-1 bg-white lg:backdrop:blur rounded-lg  ">
      ...
      <button
        onClick={() => handleClick()}
        className=" bg-green hover:bg-black hover:text-white transition w-full lg:max-w-[162px] h-16 rounded-lg flex justify-center items-center text-purple text-2xl  "
      >
        <RiSearch2Line />
      </button>
    </div>
